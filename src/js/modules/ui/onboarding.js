...
(function() {
  ...
  const TOUR_STEPS = [
    ...
    },
    {
      ...
      description: 'Кликните на любой сектор радара, чтобы увеличить его и открыть модальное окно со списком технологий этого сектора. В модальном окне вы сможете просмотреть список технологий, отфильтровать их по статусу внедрения (Внедренные/Невнедренные) и найти нужную технологию.',
      target: '#techRadar',
      position: 'center',
      showSkip: true,
      beforeShow: () => {
    ...
    },
    {
      ...
      description: 'При зуммировании сектора открывается модальное окно со списком технологий. Здесь отображаются все технологии выбранного сектора с возможностью их фильтрации по статусу внедрения (Внедренные/Невнедренные) и поиска.',
