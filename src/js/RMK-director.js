// RMK-director.js
// ===== DEPRECATED (шаг 7.5, 24.02.2026) =====
// Точка входа перенесена в src/main.js. Все модули загружаются через ES imports.
// Этот файл оставлен только для справки (история порядка загрузки). Не подключать на страницах.
//
