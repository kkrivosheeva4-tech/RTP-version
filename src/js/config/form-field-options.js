/**
 * Единый конфиг опций для селектов форм (добавление/редактирование технологии, фильтры).
 * TRL, рейтинги 0–3, статусы, подсказки (tooltips), id полей модальных форм.
 * Этап 7 рефакторинга: изменение надписи или добавление опции — в одном файле.
 */
(function () {
  'use strict';
