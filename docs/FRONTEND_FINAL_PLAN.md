...
**Обновлено:** 24.02.2026 (добавлен этап 9.5: привязка предприятий к функциональным блокам)  
**Версия:** 1.2  
...
| 9.5 | Привязка предприятий к функциональным блокам | 2–3 дня | Высокий | ⏳ Ожидает |
